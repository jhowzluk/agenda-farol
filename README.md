...
> Sistema web completo de agendamento de consultas e gestão de voluntários, desenvolvido especificamente para a clínica social Farol, apresentando controle de perfil (Admin/Voluntário), regras de negócio avançadas para limites de atendimento, fila de espera e relatórios históricos.
